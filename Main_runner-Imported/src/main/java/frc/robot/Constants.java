...
public final class Constants {
    ...
    public static class PNEUMATICS_CONSTANTS {
        public static final int solenoid_alpha_forward_channel = 2;
        public static final int solenoid_alpha_reverse_channel = 1;
    ...
    public static class TURRET_CONSTANTS {
        public static final double turret_kp = .02;
